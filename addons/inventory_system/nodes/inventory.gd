...
signal inventory_interact(inventory_data: Inventory, index: int, button: int, is_double_click: bool)
...
func _ready() -> void:
	InventoryRegistry.register(self)
	tree_exiting.connect(unregister)


func unregister():
	InventoryRegistry.unregister(self)
...
func on_slot_clicked(index: int, button: int) -> void:
	inventory_interact.emit(self, index, button, false)
